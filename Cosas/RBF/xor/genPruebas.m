function genPruebas(nom_archi,n)
    % ------------------------------------------------------
    % Genera un archivo con n valores de prueba, creados a partir de los
    ...
    % ------------------------------------------------------
    % SALIDA
	% Archivo con los ejemplos y su salida deseada
    % ------------------------------------------------------
    ...
    for k=1:cociente
        for l=1:cant_casos
            ...
            valores=genVectorAleatorio(cant_entradas,-0.5,0.5);
